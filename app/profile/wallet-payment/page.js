  ...
  return (
    <div className="max-w-6xl mx-auto px-2 py-8">
      ...
      <div className="grid gap-8 md:grid-cols-2">
        {/* Balance Card */}
        <div className="bg-[#F9FAFB] rounded-2xl flex p-3 justify-center border border-zinc-200">
        ...
        <div
          className="
      bg-white border border-zinc-200 rounded-2xl p-3  flex flex-col justify-between
      "
        >
          {/* <div className="flex justify-between mb-4">
          </div> */}
            <button className="rounded-full ml-auto bg-[#FF1A6C] px-5 py-2 text-sm font-medium text-white hover:bg-bg-[#FF1A6C]/20 transition">
              Connect Wallet
            </button>
      ...
      {/* Export Private Key */}
      <div className="mt-10 bg-white border border-zinc-200 rounded-2xl p-6  space-y-4">
